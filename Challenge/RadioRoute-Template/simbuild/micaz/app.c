...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b65458, const void *arg_0xb7b655f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b168c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79c0840), 
int (*key_eq_fn)(void *arg_0xb79c0c88, void *arg_0xb79c0e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb788f9b8, int arg_0xb788fb10);
static double RandomUniform(void );
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void RadioRouteC$Timer1$startPeriodic(uint32_t dt);
# 33 "RadioRouteC.nc"
...
static inline bool RadioRouteC$clear_queue(int8_t type);
...
#line 64
{
  uint16_t queue_addr = (void *)0;

#line 66
  if (type == RadioRouteC$ROUTE_REP[sim_node()]) {
      RadioRouteC$route_rep_sent[sim_node()] = FALSE;
    }
  else {
#line 68
    if (type == RadioRouteC$ROUTE_REQ[sim_node()]) {
        RadioRouteC$route_req_sent[sim_node()] = FALSE;
      }
    }
}
...
#line 191
    {
      ...
      sim_log_debug(159U, "radio_rec", "..::RECEIVE at %d -> dest %u src %u type %u\n", TOS_NODE_ID, __nesc_ntoh_uint16(msg->dest.nxdata), __nesc_ntoh_uint16(msg->src.nxdata), __nesc_ntoh_uint16(msg->type.nxdata));



      if (__nesc_ntoh_uint16(msg->type.nxdata) == RadioRouteC$DATA[sim_node()]) {

          sim_log_debug(160U, "radio_rec", "\t\t TYPE DATA");
          RadioRouteC$generate_send(__nesc_ntoh_uint16(msg->dest.nxdata), msg, RadioRouteC$DATA[sim_node()]);
        }
      else {
#line 202
        if (__nesc_ntoh_uint16(msg->type.nxdata) == RadioRouteC$ROUTE_REQ[sim_node()]) {
            ...
            if (__nesc_ntoh_uint16(msg->dest.nxdata) == TOS_NODE_ID) {
                ...
                RadioRouteC$generate_send(__nesc_ntoh_uint16(msg->dest.nxdata), bufPtr, RadioRouteC$ROUTE_REP[sim_node()]);
                sim_log_debug(161U, "radio_rec", "\t\tROUTE_REQ arrived to destination node %d\n", TOS_NODE_ID);
                sim_log_debug(162U, "radio_rec", "\t\tREPLY_REQ generated to %u\n", __nesc_ntoh_uint16(msg->dest.nxdata));
              }
            else 
#line 216
              {
                ...
                if (RadioRouteC$rt_next_hop[sim_node()][__nesc_ntoh_uint16(msg->dest.nxdata) - 1] != (void *)0) {
                    ...
                    temp_src = __nesc_ntoh_uint16(msg->src.nxdata);
                    __nesc_hton_uint16(msg->src.nxdata, __nesc_ntoh_uint16(msg->dest.nxdata));
                    __nesc_hton_uint16(msg->dest.nxdata, temp_src);
                    sim_log_debug(163U, "radio_rec", "\t\tROUTE founded at node %d\n", TOS_NODE_ID);
                    sim_log_debug(164U, "radio_rec", "\t\tREPLY_REQ generated to %u\n", __nesc_ntoh_uint16(msg->dest.nxdata));
                  }
                else 
#line 237
                  {
                    ...
                    sim_log_debug(165U, "radio_rec", "\t\tROUTE_REQ to node %u not found at %d\n", __nesc_ntoh_uint16(msg->dest.nxdata), TOS_NODE_ID);
                    RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, RadioRouteC$ROUTE_REQ[sim_node()]);
                  }
              }
          }
        else {
#line 247
          if (__nesc_ntoh_uint16(msg->type.nxdata) == RadioRouteC$ROUTE_REP[sim_node()]) {
              ...
              if (actual_count == (void *)0 || actual_count > __nesc_ntoh_uint16(msg->value.nxdata)) {
                  ...
                  sim_log_debug(166U, "radio_pack", "\t\tTable update at node %d -> dest: %u next_hop: %u count: %u\n", TOS_NODE_ID, __nesc_ntoh_uint16(msg->dest.nxdata), __nesc_ntoh_uint16(msg->src.nxdata), __nesc_ntoh_uint16(msg->value.nxdata));

                  RadioRouteC$clear_queue(RadioRouteC$ROUTE_REQ[sim_node()]);
                }
#line 277
              return bufPtr;
            }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7630298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7630298) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7630298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7630930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7630930, msg, payload, len);
#line 78
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioRouteC$Timer1$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      sim_log_debug(153U, "radio", "\nRadio on on node %d!\n\n", TOS_NODE_ID);
      RadioRouteC$Timer1$startPeriodic(10000);
    }
  else {
      sim_log_error(154U, "radio", "\nRadio failed to start, retrying...\n\n");
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb763f8b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb763f8b0, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb748c010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb748c010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb748c010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77eb650){
#line 75
  switch (arg_0xb77eb650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77eb650);
#line 75
      break;
#line 75
    }
...
#line 141
      ...
      __nesc_hton_uint16(msg->src.nxdata, 0);
      __nesc_hton_uint16(msg->dest.nxdata, 6);

      sim_log_debug(155U, "boot", "..::Timer1.fired -> SENDING FIRST PACKET to %u\n\n", __nesc_ntoh_uint16(msg->dest.nxdata));
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb730fc70){
#line 83
  switch (arg_0xb730fc70) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb730fc70);
#line 83
      break;
#line 83
    }
...
#line 83
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb748c9f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb748c9f8, addr, msg, len);
#line 80
...
#line 86
  if (RadioRouteC$Timer0$isRunning()) {
      sim_log_debug(148U, "radio_rec", "Timer0.isRunning()");
      return FALSE;
    }
  else 
#line 89
    {
      if (type == RadioRouteC$ROUTE_REQ[sim_node()] && !RadioRouteC$route_req_sent[sim_node()]) {
          sim_log_debug(149U, "radio_rec", "type == 1 && !route_req_sent");
...
#line 96
        if (type == RadioRouteC$ROUTE_REP[sim_node()] && !RadioRouteC$route_rep_sent[sim_node()]) {
            sim_log_debug(150U, "radio_rec", "type == 2 && !route_rep_sent");
...
#line 102
          if (type == 0) {
              sim_log_debug(151U, "radio_rec", "type == 0");
              RadioRouteC$Timer0$startOneShot(RadioRouteC$time_delays[sim_node()][TOS_NODE_ID - 1]);
              RadioRouteC$queued_packet[sim_node()] = *packet;
              RadioRouteC$queue_addr[sim_node()] = address;
            }
...
#line 150
{
  ...
  if (RadioRouteC$rt_next_hop[sim_node()][__nesc_ntoh_uint16(msg->dest.nxdata)] == (void *)0) {

      RadioRouteC$waiting_packet[sim_node()] = *packet;

      __nesc_hton_uint16(msg->src.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(msg->type.nxdata, RadioRouteC$ROUTE_REQ[sim_node()]);
      address = AM_BROADCAST_ADDR;
      sim_log_debug(156U, "radio_rec", "\t\tPRESEND -> Route discovery generated from %u to %u type %u\n", __nesc_ntoh_uint16(msg->src.nxdata), __nesc_ntoh_uint16(msg->dest.nxdata), __nesc_ntoh_uint16(msg->type.nxdata));
    }
  else 
#line 164
    {
      if (__nesc_ntoh_uint16(msg->type.nxdata) == RadioRouteC$DATA[sim_node()]) {
          address = RadioRouteC$rt_next_hop[sim_node()][__nesc_ntoh_uint16(msg->dest.nxdata)];
        }
      else {
#line 167
        if (__nesc_ntoh_uint16(msg->type.nxdata) == RadioRouteC$ROUTE_REQ[sim_node()]) {

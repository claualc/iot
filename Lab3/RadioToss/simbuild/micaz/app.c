...
typedef nx_struct radio_toss_msg {
  nx_uint16_t counter;
} __attribute__((packed)) radio_toss_msg_t;
...
typedef TMilli RadioTossC$MilliTimer$precision_tag;
...
static void RadioTossC$AMControl$startDone(error_t error);
#line 138
static void RadioTossC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void RadioTossC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void RadioTossC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void RadioTossC$MilliTimer$fired(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t RadioTossC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t RadioTossC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t RadioTossC$Packet$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void RadioTossC$MilliTimer$startPeriodic(uint32_t dt);
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
static void RadioTossC$Leds$led0Off(void );
...
static void RadioTossC$Leds$led1On(void );
#line 117
static uint8_t RadioTossC$Leds$get(void );
#line 77
static void RadioTossC$Leds$led1Off(void );
#line 94
static void RadioTossC$Leds$led2Off(void );
#line 56
static void RadioTossC$Leds$led0On(void );
#line 89
static void RadioTossC$Leds$led2On(void );
# 69 "RadioTossC.nc"
message_t RadioTossC$packet[1000];

bool RadioTossC$locked[1000];
uint16_t RadioTossC$counter[1000];

static inline void RadioTossC$Boot$booted(void );




static inline void RadioTossC$AMControl$startDone(error_t err);
...
static inline void RadioTossC$AMControl$stopDone(error_t err);



static inline void RadioTossC$MilliTimer$fired(void );
#line 115
static inline message_t *RadioTossC$Receive$receive(message_t *bufPtr, 
void *payload, uint8_t len);
#line 156
static void RadioTossC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 43 "/opt/tinyos-main-2.1.2/tos/interfaces/GeneralIO.nc"
...
static uint8_t LedsP$Leds$get(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
inline static uint8_t RadioTossC$Leds$get(void ){
#line 117
...
inline static void RadioTossC$Leds$led2Off(void ){
#line 94
  LedsP$Leds$led2Off();
#line 94
}
...
inline static void RadioTossC$Leds$led2On(void ){
#line 89
  LedsP$Leds$led2On();
#line 89
}
...
inline static void RadioTossC$Leds$led1Off(void ){
#line 77
  LedsP$Leds$led1Off();
#line 77
}
...
inline static void RadioTossC$Leds$led1On(void ){
#line 72
  LedsP$Leds$led1On();
#line 72
}
...
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
inline static void RadioTossC$Leds$led0Off(void ){
#line 61
  LedsP$Leds$led0Off();
#line 61
}
...
inline static void RadioTossC$Leds$led0On(void ){
#line 56
  LedsP$Leds$led0On();
#line 56
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static uint8_t RadioTossC$Packet$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 116
{
  ...
  if (len != sizeof(radio_toss_msg_t )) {
#line 118
      return bufPtr;
    }
  else 
#line 119
    {
      ...
      sim_log_debug(155U, "radio_rec", "Received packet at time %s\n", sim_time_string());
      sim_log_debug(156U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", RadioTossC$Packet$payloadLength(bufPtr));

      sim_log_debug_clear(157U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(158U, "radio_pack", "\t\t msg_counter: %hhu \n", __nesc_ntoh_uint16(rcm->counter.nxdata));


      if (__nesc_ntoh_uint16(rcm->counter.nxdata) & 0x1) {
          RadioTossC$Leds$led0On();
        }
      else {
          RadioTossC$Leds$led0Off();
        }
      if (__nesc_ntoh_uint16(rcm->counter.nxdata) & 0x2) {
          RadioTossC$Leds$led1On();
        }
      else {
          RadioTossC$Leds$led1Off();
        }
      if (__nesc_ntoh_uint16(rcm->counter.nxdata) & 0x4) {
          RadioTossC$Leds$led2On();
        }
      else {
          RadioTossC$Leds$led2Off();
        }


      sim_log_debug(159U, "led_0", "Led 0 status %u\n", RadioTossC$Leds$get() & LEDS_LED0);
      sim_log_debug(160U, "led_1", "Led 1 status %u\n", RadioTossC$Leds$get() & LEDS_LED1);
      sim_log_debug(161U, "led_2", "Led 2 status %u\n", RadioTossC$Leds$get() & LEDS_LED2);
      return bufPtr;
    }
}
...
#line 78
    case 6:
#line 78
      __nesc_result = RadioTossC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t RadioTossC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioTossC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      sim_log_debug(149U, "radio", "Radio on on node %d!\n", TOS_NODE_ID);
      RadioTossC$MilliTimer$startPeriodic(250);
    }
  else {
      sim_log_error(150U, "radio", "Radio failed to start, retrying...\n");
      RadioTossC$AMControl$start();
    }
}
...
#line 113
  RadioTossC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  RadioTossC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  RadioTossC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb75686a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb75686a8) {
#line 100
    case 0U:
#line 100
      /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb75686a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 53
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb75660a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb75660a0, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t RadioTossC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*RadioTossAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
inline static void * RadioTossC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 94
{
  RadioTossC$counter[sim_node()]++;
  sim_log_debug(152U, "timer", "Timer fired, counter is %hu.\n", RadioTossC$counter[sim_node()]);
  if (RadioTossC$locked[sim_node()]) {
      return;
    }
  else {
      radio_toss_msg_t *rcm = (radio_toss_msg_t *)RadioTossC$Packet$getPayload(&RadioTossC$packet[sim_node()], sizeof(radio_toss_msg_t ));
...
#line 102
      ...
      __nesc_hton_uint16(rcm->counter.nxdata, RadioTossC$counter[sim_node()]);
      if (RadioTossC$AMSend$send(AM_BROADCAST_ADDR, &RadioTossC$packet[sim_node()], sizeof(radio_toss_msg_t )) == SUCCESS) {
          sim_log_debug(153U, "radio_send", "Sending packet");
          RadioTossC$locked[sim_node()] = TRUE;
...
#line 156
{
  if (&RadioTossC$packet[sim_node()] == bufPtr) {
      RadioTossC$locked[sim_node()] = FALSE;
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module RadioTossC */
  if (!strcmp(varname, "RadioTossC$packet"))
  {
    *addr = (uintptr_t)&RadioTossC$packet[__nesc_mote];
    *size = sizeof(RadioTossC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioTossC$locked"))
  {
    *addr = (uintptr_t)&RadioTossC$locked[__nesc_mote];
    *size = sizeof(RadioTossC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioTossC$counter"))
  {
    *addr = (uintptr_t)&RadioTossC$counter[__nesc_mote];
    *size = sizeof(RadioTossC$counter[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module RadioTossC */
  memset((void *)&RadioTossC$packet[__nesc_mote], 0, sizeof RadioTossC$packet[__nesc_mote]);
  memset((void *)&RadioTossC$locked[__nesc_mote], 0, sizeof RadioTossC$locked[__nesc_mote]);
  RadioTossC$counter[__nesc_mote] = 0;
